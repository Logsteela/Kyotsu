...
export function HomePage() {
  ...
  const description = 'ほとんど全ての共通テストの問題・解答を、本試験・追試験・特例追試験・試行問題・試作問題などを問わず無料で公開しています。';
...
⑤拡大文字問題冊子<br/>
⑥点字問題冊子<br/>
・以下に示されたものは配布を行うとは限りません。一部の場合にのみ配布されます。特に、①と②に関しては、これが行われていないことが原因で解けない可能性がありますから、問題訂正や補足説明が行われたことが判明していて、その紙が失われている場合は、教科名のクリックなどで失われている旨が表示されます。<br/>
