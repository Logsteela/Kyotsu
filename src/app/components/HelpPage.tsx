        ...
        <div className="p-6 flex flex-col gap-6 overflow-y-auto">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-2">
              左側のメニューから年度を選択すると、その年度の全教科のテストが表示されます。試作問題などは年度の一番下に位置しています。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-2">
              左側のメニューから「全テスト一覧」を選択すると、掲載されている全テストが本試験→追試験→特別試験の順に表示されます。便利ではありませんが、用途はあると思います。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-2">
              ...
              「DL」ボタンでダウンロードすることができます。リスニングでは、音声をダウンロードできることもあります。音源も同様と類推してください。
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li><span className="font-semibold">正常（白背景）</span>：PDFファイルが完全に揃っています</li>
              <li><span className="font-semibold">一部欠損（赤色背景）</span>：ページの欠落や省略、音源が無いなどで一部要素が欠けており、解くのに必要または有利になる情報が十分に与えられない可能性があります。与えられている情報自体が変わらない場合（問題訂正紙と訂正前の問題の組合せなど）は、白背景となります。</li>
              <li><span className="font-semibold">完全欠損（灰色背景）</span>：問題、解答、音源がどれも欠けています。調査不足で判明していないだけで、追試験の関係などで試験自体が無い可能性もあります。</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-2">
              私はこのサイトに関する一切の著作権を放棄し、また著作者人格権の不行使を確言します。
            </p>
          </section>
        </div>
      </div>
